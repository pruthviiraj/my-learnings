[← Python · Pandas](../README.md) · [View on LeetCode ↗](https://leetcode.com/problems/patients-with-a-condition/)
...
![Runtime: 369 ms (beats 5.1%)](https://img.shields.io/badge/Runtime-369%20ms%20(beats%205.1%25)-2cbb5d?style=flat-square)
![Memory: 66.5 MB (beats 77.4%)](https://img.shields.io/badge/Memory-66.5%20MB%20(beats%2077.4%25)-2f81f7?style=flat-square)
...
def find_patients(patients: pd.DataFrame) -> pd.DataFrame:
    ...
    has_diabetes = patients['conditions'].str.contains(r'^DIAB1|\sDIAB1')
