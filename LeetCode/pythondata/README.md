...
Solved in pythondata. Every entry pairs the accepted code with a short approach: the idea first, then the steps, the complexity, and the measured runtime.
...
![Solved by difficulty](../.assets/progress-pythondata-1-0-0.svg)
...
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| 595 | [Big Countries](https://leetcode.com/problems/big-countries/) | Easy | Database | [approach](0595-big-countries/README.md)&nbsp;·&nbsp;[code](0595-big-countries/0595-big-countries.txt) | 4 | Jul&nbsp;6,&nbsp;2026 |
